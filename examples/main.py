...
from examples.test_func import test_func, test_der, test_hess
...
parser.add_argument("--log", dest="loglevel", help="Set the loglevel for your solver  (DEBUG, INFO, WARNING, CRITICAL, ERROR)", type=str, default="WARNING")
